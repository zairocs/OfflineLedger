// OfflineLedger — Universal Dynamic Custom Modal & Alert Dialog
...
> = {
  danger: {
    ...
    confirmBg: '#E53935', // Red button for destructive delete actions
    confirmText: '#FFFFFF',
  },
  warning: {
    defaultIcon: '⚠️',
    iconBg: 'rgba(255, 255, 255, 0.10)',
    iconBorder: 'rgba(255, 255, 255, 0.22)',
    confirmBg: darkColors.surfaceVariant, // Dark Gray (#333333)
    confirmText: darkColors.textPrimary,   // White (#FFFFFF)
  },
  info: {
    defaultIcon: 'ℹ️',
    iconBg: 'rgba(255, 255, 255, 0.10)',
